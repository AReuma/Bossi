<template>
  <div id="basic">
    ...
    <div style="width: 100%; display: flex; justify-content:center;">
      <v-img src="../../assets/logo/Bossi_logo_3.png"  style="height: 100px;" alt="logo"/>
    </div>
    ...
    <div>
      <v-btn @click="kakaoJoin()" class="my_btn" style="color: #3A1D1D; height: 54px" color="#F7E600" depressed>
        <v-img src="../../assets/logo/kakao_logo.png" height="20" width="20" style="margin-right: 7px" alt="kakaoLogin"/>카카오 3초만에 시작하기
      </v-btn>
      <v-btn @click="goJoinP()" variant="text" class="my_btn" style="border: 1px solid rgba(33,33,36,0.25); margin-top: 15px; height: 54px">
        이메일로 가입하기
      </v-btn>

      <div style="display: flex; justify-content: center; width: 100%; margin-top: 15px; margin-bottom: 25px">
        <v-btn @click="naverJoin()" fab style="margin-right: 30px" variant="text">
          <v-img src="../../assets/logo/Naver_logo.png" height="50" width="50" />
        </v-btn>

        <v-btn @click="googleJoin" fab style="margin-right: 30px" variant="text">
          <v-img src="../../assets/logo/Google_logo.png" height="57" width="57"/>
        </v-btn>

        <v-btn @click="githubJoin" fab variant="text">
          <v-img src="../../assets/logo/Github_logo_2.png" height="48" width="48"/>
        </v-btn>
      </div>
    </div>
    ...
    <div style="display: flex; justify-content: right; margin-top: 10px">
      <v-btn @click="search()" variant="text" color="rgba(33,33,36,0.6)">아이디/비밀번호 찾기</v-btn>
    </div>
    ...
    <div style="margin-top: 5px;">
      <v-btn @click="login()" depressed class="my_btn text-white" style="height: 54px; font-size: 17px;" color="DEEP_PINK">
        로그인
      </v-btn>
    </div>
