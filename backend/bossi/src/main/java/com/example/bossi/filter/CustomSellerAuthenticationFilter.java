...
@Slf4j
public class CustomSellerAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
...
//    }
    ...
    public CustomSellerAuthenticationFilter(AuthenticationManager authenticationManager) {
        this.authenticationManager = authenticationManager;
        this.setAuthenticationManager(authenticationManager);
        setFilterProcessesUrl("/api/v1/seller/login");
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            Seller seller = objectMapper.readValue(request.getInputStream(), Seller.class);

            log.info("email: {}", seller.getEmail());
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException, ServletException {
        ...
        CustomSellerDetails seller = (CustomSellerDetails) authentication.getPrincipal();

        log.info("principalDetails getUsername: {}", seller.getUsername());
